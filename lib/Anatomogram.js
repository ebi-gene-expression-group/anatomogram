...
var Anatomogram = function (_React$Component) {
  ...
  _createClass(Anatomogram, [{
    ...
    value: function _initialiseSvgElements(getSvgElementById) {
      ...
      attachCallbacks([].concat(_toConsumableArray(showIds), _toConsumableArray(highlightIds), _toConsumableArray(selectIds)), 'mouseover', this.props.onMouseOver, getSvgElementById);
      attachCallbacks([].concat(_toConsumableArray(showIds), _toConsumableArray(highlightIds), _toConsumableArray(selectIds)), 'mouseout', this.props.onMouseOut, getSvgElementById);
      attachCallbacks([].concat(_toConsumableArray(showIds), _toConsumableArray(highlightIds), _toConsumableArray(selectIds)), 'click', this.props.onClick, getSvgElementById);
    }
  }, {
    key: 'render',
